    ...
    <div className='flex items-center justify-center w-full h-full'>
      ...
      <div className='grid grid-cols-1'>
        ...
        <div className='w-[650px] h-[100px] mb-[20px] mt-[40px] relative border border-black bg-[#939393]'>
          ...
          <div>
            <h1 className='absolute left-0 text-white'>Email:</h1>
            <input type='email' onChange={(e) => setEmail(e.target.value)} className='absolute left-[120px] bg-white opacity-100'/>
          </div>
        </div>

        <div className='flex justify-center items-center border border-black w-[650px] h-[650px] bg-white'>
          <QRCode level='H' size={qrSize} value={"mailto:"+email} bgColor={bgColor} fgColor={fgColor} imageSettings={{
            src: qrImg,
